export const EXPERIENCE_DATA = [
    {
      ...
      content: [
        ...
        {
          text: "Developed Custom Reusable React Components, Figma-> React Components",
        },
        {
          text: "Improved UI and readablity of previously poorly-maintained code through code refactoring, optimization, and documentation",
        },
        {
          text: "Took active part in redesigning and optimisation of SEREN - new Case Managemen System",
        },
      ],
    },
    {
      ...
      content: [
        ...
        {
          text: "Developed over 50 Websites with Bootstrap Framework and WordPress/Woocommerce, HTML5, JavaScript, CSS3",
        },
        {
          text: 'Clients include: BioxSystem LTD, FatPromotions.co.uk',
        },
      ],
    },
    {
      ...
      content: [
        ...
        {
          text: "CMS modules development (workflow, access levels, search) and set up incorporating XML, Java technology, machii MVC framework- powerful object oriented MVC framework for CFML, W3C development standards, UI development for various functional modules",
        },
  
        {
          text: "Employers include: Universities Admission Center (UAC), Sydney, Hyro LTD (Brisbane), The Weather Company (Sydney), Reading Room (Sydney)",
        },
      ],
    },
  ];